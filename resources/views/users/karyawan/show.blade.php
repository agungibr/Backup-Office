...
<div class="header bg-primary pb-3">
    ...
    <div class="container mt--5 mx-auto">
        <div class="card bg-secondary shadow center" style="width: 60rem;">
            <div class="card-body">
                <form action="{{ url('/updatekaryawan/'.$data->id) }}" method="post" enctype="multipart/form-data" autocomplete="on">
                    @csrf
                    <div class="pl-lg-4">
                        ...
                        <div class="form-group{{ $errors->has('alamat') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="alamat" id="input-alamat" class="form-control form-control-alternative{{ $errors->has('alamat') ? ' is-invalid' : '' }}" placeholder="Alamat" value="{{ $data->alamat }}">
                        ...
                        <div class="form-group{{ $errors->has('telp') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="telp" id="input-telp" class="form-control form-control-alternative{{ $errors->has('telp') ? ' is-invalid' : '' }}" placeholder="Telp" value="{{ $data->telp }}">
                            @if ($errors->has('telp'))
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                            ...
                            <input type="email" name="email" id="input-email" class="form-control form-control-alternative{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Email" value="{{ $data->email }}">
                            @if ($errors->has('email'))
                                <span class="invalid-feedback" role="alert">
