...
<div class="header bg-primary pb-3">
    <div class="container-fluid">
      <div class="header-body">
        <div class="row align-items-center py-6">
            <div class="col-lg-8">
                <h6 class="h1 text-white d-inline-block mb-0">Create Data Laptop</h6>
            </div>
        </div>
      </div>
    </div>
    <div class="container mt--5 mx-auto">
        <div class="card bg-secondary shadow center" style="width: 60rem;">
            <div class="card-body">
                <form action="{{url('storelaptop')}}" method="post" enctype="multipart/form-data" autocomplete="on">
                    @csrf
                    <div class="pl-lg-4">
                        ...
                        <div class="form-group{{ $errors->has('serialnumber') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="serialnumber" id="input-serialnumber" class="form-control form-control-alternative{{ $errors->has('serialnumber') ? ' is-invalid' : '' }}" placeholder="Serial Number" value="{{ old('serialnumber') }}">
                        ...
                        <div class="form-group{{ $errors->has('merk') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="merk" id="input-merk" class="form-control form-control-alternative{{ $errors->has('merk') ? ' is-invalid' : '' }}" placeholder="Merk" value="{{ old('merk') }}">
                            @if ($errors->has('merk'))
                                <span class="invalid-feedback" role="alert">
