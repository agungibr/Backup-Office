    ...
    <div class="container-fluid">
      <div class="header-body">
        <div class="row align-items-center py-6">
            <div class="col-lg-8">
                <h6 class="h1 text-white d-inline-block mb-0">Data Laptop Kantor</h6>
            </div>
            <div class="col-lg-6">
                <a href="{{url('createlaptop')}}" class="btn btn-sm btn-neutral">New</a>
            </div>
        </div>
      </div>
    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('/destroylaptop/'.$dataLaptop->id)}}" onclick="return myFunction();"><i type="button" class="fas fa-trash-alt" style="color:red"></i></a>
                                            <script>
                                              function myFunction() {
